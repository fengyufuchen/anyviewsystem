...
<form id="pagerForm" action="admin/teacherManager/teacherManagerForUniversity.action" method="post" ></form> 

<div class="pageHeader">
<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="admin/teacherManager/teacherManagerForUniversity.action" method="post" >
			...
			<table class="searchContent" style="float: left;">
				...
				<tr>		
				   <%--  <td>
 							<div class="pages">
 							  <label>学校名称：</label>
								<select  style="width:200px" <c:if test="${admin.miden!=-1 }">disabled="disabled"</c:if> id="select_unID" name="unID" >
						...
						<%-- <td>
							<div class="pages">
							  <label>学院名称:</label>
								<select <c:if test="${admin.miden==0 }">disabled="disabled"</c:if>   style="width:200px" name="ceID" id="select_ceID" ref="combox_teacher" refUrl="teacher/schemeManager/gainTeacherByCeIdAjax.action">
									<c:choose>
