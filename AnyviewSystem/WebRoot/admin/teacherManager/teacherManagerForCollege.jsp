...
<form id="pagerForm" action="admin/teacherManager/teacherManagerForCollege.action" method="post" ></form> 

<div class="pageHeader">
<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="admin/teacherManager/teacherManagerForCollege.action" method="post" >
