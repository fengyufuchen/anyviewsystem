...
<form id="pagerForm" action="admin/teacherManager/getTeacherForSuper.action" method="post" ></form> 

<div class="pageHeader">
<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="admin/teacherManager/getTeacherForSuper.action" method="post" >
			...
			<table class="searchContent" style="float: left;">
				...
				<tr>		
				    <td>
 							<div class="pages">
 							  <label>学校名称：</label>
								<select style="width: 150px;"name="unID"  id="superAdminTeacher">
