...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li >
				<a class="add" mask="true" target="dialog"   fresh="true" rel="admin/collegeManager" href="admin/collegeManager/preAddCollege.action?unID=${unID}">
					<span>添加学院</span>
				</a>
			</li>
	...
	<table class="table" width="100%" layoutH="75">
		<thead>
			<tr>
				<th width="25%" align="center">学院名称</th>
				<th width="25%" align="center">有效状态</th>
