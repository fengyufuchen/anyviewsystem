			...
			<div id="header">
				<div class="headerNav">
					<ul class="nav">
						...
						<%
							if(session.getAttribute("User") instanceof StudentTable){
								StudentTable stu = (StudentTable)session.getAttribute("User");
							if(stu != null){
						 %>
							<%= ((StudentTable)session.getAttribute("User")).getSname()%>同学</a>
						<% } else 
